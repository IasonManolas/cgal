...
public:
  ...
  bool execute_operation(const ElementType& edge, C3t3& c3t3) override {
    ...
    logger.log("EXEC handles: edge_cell=", (const void*)(&*edge.first), " v0=", (const void*)(&*v0),
               " v1=", (const void*)(&*v1));
#endif
...
template <typename C3t3, typename SizingFunction, typename CellSelector, typename Visitor>
thread_local std::set<std::size_t> CGAL::Tetrahedral_remeshing::internal::
    EdgeCollapseOperation<C3t3, SizingFunction, CellSelector, Visitor>::m_locked_cells_timestamps;
#endif
